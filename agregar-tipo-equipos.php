...
if (!isset($_GET['id'])) {
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Registre el tipo de Equipo</h4>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post"
                                      action="/assets/scriptsphp/insertar-tipo-equipo.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="file" name="foto" class="dropify" data-height="100"
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post"
                                      action="/assets/scriptsphp/update-tipos.php">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="example-email">Nombre</label>
                                        <div class="col-md-4">
                                            <input type="hidden" name="codigo_tipo" value="<? echo $_GET['id'];?>">
                                            <input type="hidden" name="pagina" value="<? echo $_SERVER['PHP_SELF']; ?>">
                                            <input type="text" name="nombre" class="form-control"
                                                   value="<? echo utf8_encode($row['nombre']); ?>">
                                        </div>
                                    </div>
                                    <br>
                                    <br>
