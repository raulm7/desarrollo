...
if ($_SESSION['permiso'] == 51){
    header('Location: ../../editar-mis-clientes-agente.php');
}
                    ...
                    <div class="card-box">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="m-b-30">
                                        <a href="agregar-usuarios-wizard.php" class="btn btn-primary waves-effect waves-light">Agregar <i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
