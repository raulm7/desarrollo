    ...
    <?php include "assets/include/navbar.php";?>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Tipos de usuario</h4>
                    </div>
                </div>
                        ...
                        <div class="card-box">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="m-b-30">
                                                <a href="agregar-tipo-usuarios.php" class="btn btn-primary waves-effect waves-light">Agregar <i class="fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            jQuery('.editBtn').on('click', function () {
                ...
                document.location.href = ("agregar-tipo-usuarios.php?id="+values[0]);
            });
        </script>
    </body>
</html>
