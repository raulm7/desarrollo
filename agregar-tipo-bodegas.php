                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">Ingrese un nuevo tipo de bodega</h4>

                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="/assets/scriptsphp/insertar-tipo-bodega.php">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="nombre">Tipo de Bodega</label>
                                            <div class="col-md-4">
                                                <input type="hidden" name="pagina" value="<?echo $_SERVER['PHP_SELF'];?>">
                                                <input type="text" name="nombre" class="form-control" placeholder="Tipo de Bodega">
                                            </div>
                                        </div>
...
<?php }else{
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Editar tipo bodega</h4>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <h4 class="header-title m-t-0 m-b-30">Editar tipo de bodega</h4>
                            ...
                            <div class="col-lg-12">
                                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="/assets/scriptsphp/update-tipos.php">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="hidden" name="pagina" value="<?echo $_SERVER['PHP_SELF'];?>">
                                            <input type="text" name="nombre" class="form-control" value="<?echo utf8_encode($row['nombre']);?>">
                                        </div>
                                    </div>
                                    <br>
                                    <br>
