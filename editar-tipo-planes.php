    ...
    <?php include "assets/include/navbar.php";?>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Tipos de planes</h4>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registrar nuevo tipo de plan</h4>
                </div>
                <br>
                <br>
                <form action="assets/scriptsphp/insertar-tipo-plan.php" method="post" role="form">
                    <label class="control-label" for="nombre">Tipo de Plan</label>
                    <br>
                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre de tipo de Plan" autofocus>
                    <br>
                    <br>
        ...
        <script type="text/javascript">
            ...
            jQuery('.editBtn').on('click', function () {
                ...
                document.location.href = ("agregar-tipo-planes.php?id="+values[0]);
            });
        </script>
    </body>
</html>
