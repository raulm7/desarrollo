            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card-box p-b-0">
                        <div id="progressbarwizard1" class="pull-in">
                            <ul>
                            ...
                            <div class="tab-content b-0 m-b-0">
                                ...
                                <div class="tab-pane p-t-10 fade" id="user-tab-1">
                                    <div class="row">
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="nombres" class="form-control"
                                                       value="<? echo $row['nombres']; ?>" placeholder="Nombres">
                                            </div>
                                            <label class="col-md-1 control-label " for="Apellidos">Apellidos *</label>
                                            <div class="col-md-5">
                                                <input type="text" name="apellidos" class="form-control"
                                                       value="<? echo $row['apellidos']; ?>" placeholder="Apellidos">
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-5">
                                                <input type="email" id="email" name="email" class="form-control"
                                                       value="<? echo $row['email']; ?>" placeholder="Email">
                                            </div>
                                            <label class="col-md-1 control-label " for="NIT">NIT *</label>
                                            <div class="col-md-5">
                                                <input type="text" name="nit" class="form-control"
                                                       value="<? echo $row['nit']; ?>" placeholder="NIT">
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            ...
                                            <label class="col-md-1 control-label " for="Estado Civil">Estado Civil
                                                *</label>
                                            <div class="col-md-5">
                                        ...
                                        <div class="form-group clearfix">
                                            <label class="col-md-1 control-label " for="Fecha de Nacimiento">Fecha de
                                                Nacimiento *</label>
                                            <div class="col-md-5">
                                                <input type="date" class="form-control"
                                                       value="<? echo substr($row['edad'], 0, 10); ?>"
                                        ...
                                        <div class="form-group clearfix">
                                            <label class="col-md-1 control-label " for="Departamento">Departamento
                                                *</label>
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" placeholder="Municipio"
                                                       value="<? echo $row['codigo_municipio']; ?>" name="municipio">
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            ...
                                            <label class="col-md-1 control-label " for="Comentarios">Comentarios
                                                *</label>
                                            <div class="col-md-5">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-5">
                                                <input type="number" name="zona" class="form-control" max="25"
                                                       value="<? echo $row['zona']; ?>" maxlength="2">
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                        ...
                                        <div class="form-group clearfix">
                                            <label class="col-md-1 control-label " for="Número Casa">Número Casa
                                                </label>
                                            <div class="col-md-5">
                                        ...
                                        <div class="form-group clearfix">
                                            <label class="col-md-1 control-label " for="numero_casa">Comisión</label>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="numero_casa"
                                                       value="<? echo $row['comision']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group clearfix">
                                            ...
                                            <button type="button" class="btn btn-primary waves-effect waves-light"
                                                    data-toggle="modal" data-target="#modalAgregarContrato">Nuevo
                                                Contrato <i class="fa fa-plus"></i></button>
                                            <div class="">
                                    ...
                                    <div class="row">
                                        <div class="form-group clearfix">
                                            <input type="hidden" id="codigo_cliente" name="codigo_cliente"
                                                   value=<? echo $_GET['id']; ?>>
                                            <button type="button" class="btn btn-primary waves-effect waves-light"
                                                    data-toggle="modal" data-target="#modalAsignarEquipos">Asignar
                                                Equipos <i class="fa fa-plus"></i></button>
                                            <div class="">
                                                <table class="table table-striped" id="tablaContratos">
                                                    <thead>
                                                    <tr>
                                ...
                                <ul class="pager m-b-0 wizard">
                                    ...
                                    <li class="next"><a href="#"
                                                        class="btn btn-primary waves-effect waves-light">Next</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function () {
            ...
            $('#progressbarwizard1').bootstrapWizard({
                onTabShow: function (tab, navigation, index) {
                    ...
                    $('#progressbarwizard1').find('.bar').css({width: $percent + '%'});
                },
...
<?php } else {
    ...
    if ($_SESSION['permiso'] == getCodigoTipo("ADMIN")) {
        console_log("Adentro de else");
    } else {
    ...
    if ($result = $con->query($query)) {
        ...
        <div class="tab-pane p-t-10 fade" id="user-tab-1">
            ...
            <div class="row">
                <form action="assets/scriptsphp/update-usuario.php" enctype="multipart/form-data" method="post"
                      role="form">
                    <div class="form-group clearfix">
                        ...
                        <label class="col-md-1 control-label " for="Nombres">Nombres *</label>
                        <div class="col-md-5">
                            <input type="text" name="nombres" class="form-control" value="<? echo $row['nombres']; ?>"
                                   placeholder="Nombres">
                        </div>
                        <label class="col-md-1 control-label " for="Apellidos">Apellidos *</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <label class="col-md-1 control-label " for="NIT">NIT *</label>
                        <div class="col-md-5">
                            <input type="text" name="nit" class="form-control" value="<? echo $row['nit']; ?>"
                                   placeholder="NIT">
                        </div>
                    </div>
                    <div class="form-group clearfix">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-md-5">
                            <input type="date" class="form-control" value="<? echo substr($row['edad'], 0, 10); ?>"
                                   name="fecha_nacimiento" id="fecha_nacimiento">
                        </div>
                        <label class="col-md-1 control-label " for="DPI">DPI *</label>
                        <div class="col-md-5">
                    ...
                    <? if ($row['codigo_tipo'] === getCodigoTipo("Agente")){?>
                    <div class="form-group clearfix">
                        <label class="col-md-1 control-label " for="comision">Comisión</label>
                        <div class="col-md-5">
                ...
                <div class="row">
                    <div class="form-group clearfix">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                                data-target="#modalAgregarContrato">Nuevo Contrato <i class="fa fa-plus"></i></button>
                        <div class="">
                            <table class="table table-striped" id="tablaContratos">
                                <thead>
                                <tr>
        ...
        <? if (!($_SESSION['permiso'] == getCodigoTipo("Cliente")) && (isset($_GET['id']))) { ?> <!-- Verificacion para mostrar o no la tabla de asignación de equipos -->
            <div class="tab-pane p-t-10 fade" id="service-tab-3">
                <div class="row">
                    <div class="form-group clearfix">
                        <input type="hidden" id="codigo_cliente" name="codigo_cliente" value=<? echo $_GET['id']; ?>>
                        <? if ($_SESSION['permiso'] == getCodigoTipo("ADMIN")) { ?>
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                                    data-target="#modalAsignarEquipos">Asignar Equipos <i class="fa fa-plus"></i>
                            </button>
                        <? } ?>
                        <div class="">
                            <table class="table table-striped" id="tablaContratos">
        ...
        header("Location:agregar-usuarios-wizard.php");
    }
    ?>
    <ul class="pager m-b-0 wizard">
        <li class="previous first" style="display:none;"><a href="#">First</a></li>
