    ...
    <?php include "assets/include/navbar.php";?>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Planes por tipos</h4>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Asociar Plan con Tipos</h4>
                </div>
                <br>
                <form action="assets/scriptsphp/insertar-plan-por-tipo.php" method="post" role="form">
                    <div class="form-group">
                        <input type="hidden" name="pagina" value="<? echo $_SERVER['PHP_SELF'];?>">
                        <label class="control-label" for="nombre">Seleccionar tipo:</label>
                            <?getSelectTipo("EQU");?>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="codigo_plan">Seleccionar plan:</label>
                        <? getSelectPlanes();?>
                    </div>
                    <div class="form-group">
