...
?>
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Tipos de bodega</h4>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registrar nuevo tipo de bodega</h4>
                </div>
                <br>
                <br>
                <form action="assets/scriptsphp/insertar-tipo-bodega.php" method="post" role="form">
                    <label class="control-label" for="nombre">Tipo de Bodega</label>
                    <br>
    ...
    <script type="text/javascript">
        ...
        jQuery('.editBtn').on('click', function () {
            ...
            document.location.href = ("agregar-tipo-bodegas.php?id="+values[0]);
        });
    </script>
    </body>
    </html>
