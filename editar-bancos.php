                        ...
                        <div class="card-box">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="m-b-30">
                                                <a href="agregar-bancos.php" class="btn btn-primary waves-effect waves-light">Agregar <i class="fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            jQuery('.delBtn').on('click', function () {
                ...
                if (r === true) {
                    ...
                    $.ajax({
                        url: "assets/scriptsphp/borrar-bancos.php",
                        data: {
                            "codigo_banco": id
                        },
                        cache: false,
            ...
            jQuery('.editBtn').on('click', function () {
                ...
                document.location.href = ("agregar-bancos.php?id=" + values[0]);
            });
        </script>
    </body>
</html>
