                    ...
                    <div class="modal-content">
                        ...
                        <form action="assets/scriptsphp/operacion-recargar-usuario.php" method="post" role="form">
                            <div class="form-group">
                                ...
                                <input type="number" name="cantidad_recarga" id="inputModalSaldoCantidadRecarga" class="form-control" max=<? echo getSaldoActual($_SESSION['codigo_cliente']); ?> step="1" autofocus>
                            </div>
                            <br>
                            <button class="btn btn-primary waves-effect waves-light" type="submit">
                                Realizar Recarga
            ...
            <div id="modalRecargarServicio" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <br>
                        <form action="assets/scriptsphp/operacion-recargar-servicio.php" method="post">
                            <div class="form-group">
