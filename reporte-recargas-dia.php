...
?>
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Recargas del Día[Reporte]</h4>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        <div class="panel-body">
                            ...
                            <form action="reporte-recargas-dia.php" class="form-inline">
                            ...
                            <div class="">
                                <table class="table table-striped" id="tablaUsuarios">
                                    ...
                                    <tr>
                                        ...
                                        <? getReporteTransComisionesAgentes($_GET['periodo'],$_GET['year']);?>
                                </table>
                            </div>
                        </div>
                        <!-- end: panel body -->
